...
export const requestPasswordReset = (email) => axiosInstance.post("/users/password-reset/request/", { email });

export const confirmPasswordReset = (data) => axiosInstance.post("/users/password-reset/confirm/", data);
